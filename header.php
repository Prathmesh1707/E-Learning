...
<head>
	...
	<meta name=description content="SkillUpNow">
		...
		<header id="header" class=" full-header" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.php?pag=home" class="standard-logo" data-dark-logo="images/logo.png"><img src="images/logo.png" alt="Exceptional Logo"></a>
						<a href="index.php?page=home" class="retina-logo" data-dark-logo="images/logo.png"><img src="images/logo.png" alt="exceptional Logo"></a>
					</div><!-- #logo end -->
					...
					<nav id="primary-menu" class="dark">
						...
						<ul>
							...
							<li><a href="gotoep/"><div>Admin</div></a> </li>
