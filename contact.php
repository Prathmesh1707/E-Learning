...
<?php
	...
	if(isset($_POST['submit'])){        
        ...
        if( ( isset($name) && !empty($name) ) && ( isset($email) && !empty($email) ) && ( isset($user_msg) && !empty($user_msg) ) && ( isset($phone) && !empty($phone) ) ) {
            ...
            $to = "skillupnow07@gmail.com"; //Programmers email
            ...
            $header  = "skillupnow07@gmail.com";
            $subject = "Thank You $name";
            $message = "We are here for achieve your expectations. \nThank you for your FEEDBACK Form SkillUpNow.\n CEO EP";
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="sidebar col_last nobottommargin">
						...
						<abbr title="Email Address"><strong>Email:</strong></abbr> skillupnow07@gmail.com

					
						<div class="widget noborder notoppadding">

							<a target="_blank"  class="social-icon si-small si-dark si-facebook">
								<i class="icon-facebook"></i>
								<i class="icon-facebook"></i>
							</a>

							<a target="_blank"  class="social-icon si-small si-dark si-twitter">
								<i class="icon-twitter"></i>
								<i class="icon-twitter"></i>
							</a>

							<a target="_blank" class="social-icon si-small si-dark si-youtube">
								<i class="icon-youtube-play"></i>
								<i class="icon-youtube-play"></i>
							</a>

							<a target="_blank" class="social-icon si-small si-dark si-gplus">
								<i class="icon-gplus"></i>
								<i class="icon-gplus"></i>
							</a>

							<a target="_blank" class="social-icon si-small si-dark si-dropbox">
								<i class="icon-dropbox2"></i>
								<i class="icon-dropbox2"></i>
							</a>

							<a target="_blank"  class="social-icon si-small si-dark si-github">
